...
Moving4:
  ...
  return(1);
MoveRight:
  SetXDir(0+Local(2)/4-2);
  return(1);
MoveLeft:
  SetXDir(0-Local(2)/4+2);
  return(1);
MoveRight2:
  SetXDir(0+Local(2)/2-7);
  return(1);
MoveLeft2:
  SetXDir(0-Local(2)/2+7);
  return(1);
MoveRight3:
  SetXDir(0+Local(2)-20);
  return(1);
MoveLeft3:
  SetXDir(0-Local(2)+20);
  return(1);
...
ContainedDigSingle:
 ...
 return(1);
Display:
  Message("Restbenzin (Super plus): %d von 20000",this(),Local(1));
  return(1);
...
public GetResearchBase: return(OV22);
