...
Tanken3:
  ...
  if(GreaterThan(Local(1),15000)) return(Call("FullTank"));
  Message("Treibstoff: %d von 15000",this(),Local(1));
 return(1);
FullTank:
  SetLocal(1,15000);
...
ContainedDigSingle:
 ...
 return(1);
Display:
  Message("Restbenzin (Super plus): %d von 15000",this(),Local(1));
  return(1);
...
public GetResearchBase: return(SL50);
